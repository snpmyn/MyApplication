...
public class RoundCornerMessageDialog extends BaseInstanceDialog {
    ...
    protected void setListener() {
        roundCornerMessageDialogBtnLeft.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        roundCornerMessageDialogBtnRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setLeftButtonDefaultSelect() {
        roundCornerMessageDialogBtnLeft.setBackground(ContextCompat.getDrawable(context, R.drawable.color_primary_white_solid_blr12_selector));
    ...
    private void setRightButtonDefaultSelect() {
        roundCornerMessageDialogBtnRight.setBackground(ContextCompat.getDrawable(context, R.drawable.color_primary_white_solid_brr12_selector));
    ...
    public static class Builder {
        private RoundCornerMessageDialog roundCornerMessageDialog;
