package com.example.fairy.utils.data;
...
public class CaesarCipherUtils {
     ...
     * @return 解密后输入流
     */
    public static InputStream wrapInputStream(InputStream inputStream, int offsetValue) {
     ...
     * @return 加密后输出流
     */
    public static OutputStream wrapOutputStream(OutputStream outputStream, int offsetValue) {
